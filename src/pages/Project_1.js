      ...
      <div className='project-main'>
        ...
        <div className='project-second'>
            <div className='d-script'>
                ...
                <p>This website is built with vanilla HTML and CSS but also features some of my first functional JavaScript logic. It includes a system to track study times and log them into a report, demonstrating my ability to implement basic interactivity and data handling.</p>
